...
const MidSection = () => {
  const textParagraph =
    "Bacharel em Engenharia de Software atualmente estou buscando novas oportunidades no campo do desenvolvimento. Com 2 experiências solidas de Full-Stack e Front-End e usando as melhores práticas de design e desenvolvimento creio que posso me tornar o melhor no que faço.";
